...
#include <locale.h> // Inclui a biblioteca para manipulacao de localidade

int main() {
    setlocale(LC_NUMERIC, "en_US.UTF-8"); // Define o locale para os Estados Unidos (para formatacao numerica)
    ...
    printf("Idade: %d anos\n", idade);
    printf("Salario: $%'0.2f\n", salario); // Formata o salario com virgula para milhares e ponto para decimais
    printf("Cidade: %s\n", cidade);
    printf("Estado: %s\n", estado);
